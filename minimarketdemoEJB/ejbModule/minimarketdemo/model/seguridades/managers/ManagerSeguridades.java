...
public class ManagerSeguridades {
    ...
    public void inicializarDemo() throws Exception {
		...
		///
		modulo=new SegModulo();
		modulo.setNombreModulo("Talento Humano");
		modulo.setRutaAcceso("thumano/menu");
		mDAO.insertar(modulo);
		idSegModuloAuditoria=modulo.getIdSegModulo();
		///
		modulo=new SegModulo();
		modulo.setNombreModulo("Inventario");
		modulo.setRutaAcceso("inventario/menu");
		mDAO.insertar(modulo);
		idSegModuloAuditoria=modulo.getIdSegModulo();
		///
		modulo=new SegModulo();
		modulo.setNombreModulo("Inventario Bodega");
		modulo.setRutaAcceso("inventario/inventariobodeguero/menu");
		mDAO.insertar(modulo);
		idSegModuloAuditoria=modulo.getIdSegModulo();
    ...
    public void insertarUsuario(SegUsuario nuevoUsuario) throws Exception {
    	...
    	mAuditoria.mostrarLog(LoginDTO.class, "actualizar usuario", "Usuario: "+nuevoUsuario.getIdSegUsuario()+" fue actualizado correctamente.");
    }
    ...
    public void actualizarUsuario(SegUsuario edicionUsuario) throws Exception {
    	...
    	mAuditoria.mostrarLog(LoginDTO.class, "insertar nuevo ususrio", "Usuario: "+usuario.getNombres()+" creado correctamente.");
